...
export default function LessonPageCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full flex items-stretch gap-0 rounded-2xl bg-slate-900/60 border border-white/5 hover:border-blue-500/30 text-left transition-all overflow-hidden group min-h-[5.5rem]"
    >
      ...
      <div className="flex-1 flex items-center gap-3 min-w-0 py-3 pr-4 pl-4 sm:pl-5 border-l border-white/5">
