...
description: Concrete MUST/SHOULD/NEVER rules for accessible, fast, delightful web UI — keyboard support, focus management, hit targets, forms, validation, animation, layout, content, performance, and contrast. Use when auditing or building interface behavior, not aesthetics. Source: vercel-labs/web-interface-guidelines.
---
